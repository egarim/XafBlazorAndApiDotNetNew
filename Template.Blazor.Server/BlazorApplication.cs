...
namespace Template.Blazor.Server {
    public partial class TemplateBlazorApplication : BlazorApplication {
        public TemplateBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void TemplateBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
