...
namespace Template.WebApi {
    public partial class TemplateWebApiApplication : BlazorApplication {
        public TemplateWebApiApplication() {
            InitializeComponent();
        }
        ...
        private void TemplateWebApiApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
